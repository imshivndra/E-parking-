...
router.post('/nearbyparkingwithlocation',UserSearchController.NearByParkingsByPlace);
router.post('/parkingdetails',VerifyUserJWT,UserSearchController.ParkingDetails);
